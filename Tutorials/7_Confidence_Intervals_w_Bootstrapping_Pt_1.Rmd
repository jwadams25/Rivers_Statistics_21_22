---
title: "7 Confidence Intervals with Bootstrapping, Part 1"
author: "TABLE NUMBER"
output: 
  html_document:
    toc: true
...
Having read about the process of building a confidence interval with boostrapping, you will now explore the topic even further by building a confidence interval using that method. For this part of the activity, you will generate the bootstrap samples using the bucket of marbles you have at your desk and use R to visualize your bootstrapped proportions and generate a confidence interval. The next tutorial will walk through how to do the whole process with R.   
...
#### a. Place the Population bin (the one with all of the blue and green marbles) to the left of the bin labled SAMPLE (the Dunks cup). 
...
#### c. After selecting 20, calculate the proportion of marbles in your sample that are blue? (record answer below after p-hat = )

p-hat = 

#### d. Is the proportion you generated in question c a parameter or a statistic?



# 3: Generate the Boostrapped Samples
...
#### a. Assign somone the role of sampler. This person will, when instructed below, select the marbles to create the bootstrapped samples. 

Name of the Sampler = 

#### b. Assign someone the role of counter. This person will count the number of blue marbles selected and calculate each bootstrapped proporiton. Have a phone calculator on the ready for this one. 

Name of the Counter = 

#### c. Assign somone the role of Data Entry Specialist. This person should have the computer that has been used so far to answer the questions above. This person will enter the proportions into R. 
...
#### c. Sampler - Put the marble back into the bin labled sample. 
...
bootstraps_data <- data.frame(
                      bootstrapped_proportions = c(NUMBER_FROM_F))
```
...
#### g. Write a sentence interpreting the confidence interval you just created. This sentence should help answer our originial question, "What proportion of the marbles in the population bin are blue?"
