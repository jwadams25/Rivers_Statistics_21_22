...
***For the rest of this tutorial, you will work with a smaller version of this data set. We'll keep the 50 rows, but select 7 of the 18 varaibles we started with. The code below makes this new data frame.***
