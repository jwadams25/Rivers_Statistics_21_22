...
For the rest of this tutorial, you will work with Let's start by selecting a few of these variables.
...
1.  What question could be explored with the visualization created by the code above?
...
3. In the code below, replace NAME_OF_DATA_FRAME with the name you wrote in question 1.
...
3.In the code below, change geom_histogram() to geom_density()
...
You may also want to adjust the scales. In the case above, you see the x-axis goes from
...
1. Without running the code below, what type of visualization will it create?

2. What variable is on the x-axis?

3. Did I choose the same bin width as you did in 6.2?

4. Run the chunk of code. (Note: Before you ask me a question read the next task)

5. "Hey, Mr. Adams! This code doesn't work!" Indeed it doesn't. Which part of the code did it reference in the Error message?

6. Adjust the section of the code referenced in the error message (Hint: Look back at the histogram from 6b to get a sense of what scale you want to put on the x-axis.)
...
Alright, you have done a lot to improve the orginial histogram that appeared! Let's keep getting your visualization ready for prime time!
