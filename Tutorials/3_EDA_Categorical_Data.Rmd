...
Copy and paste the link below to read a description of the dataset - http://openintrostat.github.io/openintro/reference/immigration.html
...
We've talked a lot about clear and effective communication. One way to do that when making a table is by ordering the table in a meaningful way. The political ideology variable is not ordinal so we can order the table from least to greatest or greatest to least. Again, one additional line of code to what we've already created will do just that. 
...
Making a bar graph without adjusting any design elements should be your first step when exploring data. Keep it simple and keep your process short as you start learning about the data. Only after that can you begin to say things like, "Oh, given what it shows, I should change the title to ___, the scales on the axes need adjusting, and flip it horizontally." 

This next section of this tutorial will guide you through adding or adjusting layers of code to produce a more polished bar graph. These are the steps you are taking as you prepare to put your visualizations into a paper or presentation. 
...
Again, feel free to reference this site for the names of the colors you want. 
...
Answering that question requires you to explore two categorical variables. This part of the tutorial will walk you through building contingency tables and filled bar plot 

## 2.1: Contingency Table with Counts

Let's start by recreating the table you saw on this homework problem. To get a refresher, visit question 2 after going to this link - https://openintro-ims.netlify.app/explore-categorical.html 

### 2.1: Tasks and Questions

1. Change NAME_OF_DATA_FRAME and SECOND_VARIABLE so you can create the two way table with the right information. 
...
2. Change NAME_OF_DATA_FRAME, FIRST_VARIABLE, and SECOND_VARIABLE in the code below to create the filled bar graph you made in question 1. 

3. Add in a title and labels for each axis. 
...
5. After your brief celebration, write answer the question we started with in this part of the tutorial: 
"Do political ideology and views on immigration appear to be associated?"
