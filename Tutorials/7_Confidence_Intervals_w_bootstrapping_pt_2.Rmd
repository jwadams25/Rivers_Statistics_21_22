---
title: "7 Confidence Intervals with Bootstrapping, Part 2"
author: "YOUR NAME"
output: 
  html_document:
    toc: true
...
Hint: Look closely at the code above to be sure you know what the name of the data frame is and the name of the variable is that represents the bootstrapped proportions. 
...
***Tips: You are going to use the data frame that contains the 1000 bootstrapped proportions.***
